  ...
  <v-container class="pa-8">
    ...
    <p class="body-text text-body-1 text-white">
      ...
      <v-list bg-color="transparent">
        <v-list-item
          v-for="missionBullet in missionBullets"
          :key="missionBullet"
        >
    ...
    <p class="body-text text-body-1 text-white">
      ...
      <router-link
        :to="{ path: 'new-patients' }"
        @click="appStore.setActiveId('new-patients')"
    ...
    <p class="body-text text-body-1 text-white">
      ...
      >
        ...
        <v-list-item
          v-for="serviceBullet in serviceBullets"
          :key="serviceBullet"
        >
        ...
        <v-list-item>
          ...
          <v-list bg-color="transparent">
            <v-list-item
              v-for="counselingBullet in counselingBullets"
              :key="counselingBullet"
            >
              <v-icon :icon="mdiHospital" class="mx-2" color="primary" />
              {{ counselingBullet }}
            </v-list-item>
    ...
    <v-row justify="center" align="center">
      <v-col cols="12" md="8">
        ...
        >
          ...
          <v-list-item>
            ...
            <a href="https://www.orangecountypcc.org/" target="blank"
              >Orange County Parent Child Center</a
            >
          </v-list-item>
          <v-list-item>
            <v-icon :icon="mdiHospital" class="mx-2" color="white" />
            <a href="https://www.familyplacevt.org/playgroups/" target="blank"
              >The Family Place</a
            >
          </v-list-item>
        </v-list>
      ...
      <v-col cols="12" md="4">
        ...
        <figcaption class="text-white text-center">
          <small
            >A child plays with a book in the South Royalton Health Center
            patient waiting room.</small
          >
        </figcaption>
      </v-col>
    </v-row>
...
const serviceBullets = [
  ...
  "Mental Health Care",
  "24 Hour Clinician Availability (after-hours by phone)",
];
