      ...
      <v-window v-model="tab" class="text-white">
          ...
          <v-list bg-color="transparent">
            <v-list-item v-for="item in generalHelp" :key="item.id">
              <a :href="item.url" target="_blank"
                ><strong>{{ item.text }}</strong></a
              >
              <v-list-item v-if="item.subtext" class="text-body-medium">{{
                item.subtext
              }}</v-list-item>
              ...
              >
                <v-list bg-color="transparent">
                  <v-list-item :key="item.id">
                    ...
                    <v-img
                      v-if="item.text === 'Veggie VanGo'"
                      class="my-2"
                      :src="veggieVanGo"
                      alt="Logo for the Veggie VanGo food pantry."
                      width="200"
                      height="200"
                    />
        ...
        <v-window-item value="expenses">
          <v-container fluid>
            <v-row no-gutters>
              <v-col
                v-for="item in expenseResources"
                :key="item.id"
                cols="12"
                md="6"
                lg="4"
              >
                <v-list bg-color="transparent">
                  <v-list-item>
                    ...
                    <v-img
                      v-if="item.text === 'Capstone'"
                      class="my-2"
                      :src="capstoneLogo"
                      alt="Logo for Capstone."
                      width="200"
                      height="56"
                    />
        ...
        <v-window-item value="mental-health">
          <v-container>
            <v-row no-gutters>
              ...
              <v-col
                v-for="item in mentalHealthResources"
                :key="item.id"
                cols="12"
                md="6"
                lg="4"
              >
                <v-list bg-color="transparent">
                  <v-list-item>
                    ...
                    <v-img
                      v-if="item.text === '988 Suicide and Crisis Line'"
                      class="my-2"
                      :src="logo"
                      alt="988 Suicide Crisis Hotline"
                      width="200"
                      height="56"
                    />
                    <v-img
                      v-if="item.text === 'Clara Martin Center (CMC)'"
                      class="my-2"
                      :src="claramartinLogo"
                      alt="Logo for the Clara Martin Center."
                      width="200"
                      height="56"
                    />
                    <v-img
                      v-if="item.text === 'Suicide, Drug, and Alcohol Crisis Hotline'"
                      class="my-2"
                      :src="headrestLogo"
                      alt="Logo for the Suicide, Drug, and Alcohol Crisis Center."
                      width="200"
                      height="56"
                    />
        ...
        <v-window-item value="parenting-childcare">
          <v-container>
            <v-row no-gutters>
              <v-col
                v-for="item in parentingAndChildResources"
                :key="item.id"
                cols="12"
                md="6"
              >
                <v-list bg-color="transparent">
                  <v-list-item>
                    ...
                    <v-img
                      v-if="item.text === 'The Family Place'"
                      class="my-2"
                      :src="theFamilyPlaceLogo"
                      alt="Logo for The Family Place childcare center."
                      width="200"
                      height="56"
                    />
                    <v-img
                      v-if="item.text === 'Orange County Parent Child Center'"
                      class="my-2"
                      :src="ocpccLogo"
                      alt="Logo for the Orange County Parent Child Center"
                      width="200"
                      height="56"
                    />
                    <v-img
                      v-if="item.text === 'Bright Futures Childcare Information System'"
                      class="my-2"
                      :src="vtdcf"
                      alt="Logo for the Vermont Department for Children and Families"
                      width="200"
                      height=""
                    />
        ...
        <v-window-item value="transportation">
          <v-container>
            <v-row no-gutters>
              <v-col
                v-for="item in transportationResources"
                :key="item.id"
                cols="12"
                md="6"
              >
        ...
        <v-window-item value="domestic-violence">
          <v-container>
            <v-row no-gutters>
              <v-col
                v-for="item in domesticViolenceResources"
                :key="item.id"
                cols="12"
                md="6"
                lg="4"
                ...
                <v-list bg-color="transparent">
                  <v-list-item>
                    ...
                    <v-img
                      ...
                      class="my-2"
                      :src="wiseLogo"
                      alt="Logo for WISE organization."
                      width="200"
                      height="96"
                    />
                    <v-img
                      v-if="item.text === 'New Hampshire Coalition'"
                      class="my-2"
                      :src="nhcLogo"
                      alt="Logo for the New Hampshire Coalition against domestic violence"
                      width="128"
                      height="96"
                    />
                    <v-img
                      v-if="item.text === 'Safeline Inc'"
                      class="my-2"
                      :src="safelineLogo"
                      alt="Logo for the Safeline Domestic Violence Victims Hotline"
                      width="128"
                      height="96"
                    />
